...
<schema xmlns="http://purl.oclc.org/dsdl/schematron" queryBinding="xslt2">
	...
	of DPDIRECT API_Gateway (DataPower) configuration files.</title>
	<pattern>
...
<!--		<rule context="OperationConfig/RequestPolicyConfig/BackendRouting[@async = 'true']">
	...
	<pattern>
		...
		<rule context="Transform|Filter">
			...
			<let name="LOCALISE_SERVICE_DIR" value="replace($LOCALISE_SCHEMA_DIR,'local:///Json_RestAPI','configuration/Json_RestAPI/src')"/>

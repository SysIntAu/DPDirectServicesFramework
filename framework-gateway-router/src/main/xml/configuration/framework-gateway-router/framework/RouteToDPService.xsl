...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform"
	...
	<xsl:variable name="ROUTING_DOC"
		select="document(concat($GATEWAY_ROUTER_ROOT_FOLDER,'config/framework-gateway-router_V1_ServiceRoute.xml'))"/>
	...
	<xsl:template match="/">
		...
		<!--<dp:set-variable name="'var://service/strict-error-mode'" value="'0'"/>-->
		<xsl:choose>

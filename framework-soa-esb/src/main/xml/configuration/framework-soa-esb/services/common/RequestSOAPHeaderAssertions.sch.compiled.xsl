...
<axsl:stylesheet xmlns:axsl="http://www.w3.org/1999/XSL/Transform" xmlns:iso="http://purl.oclc.org/dsdl/schematron" xmlns:sch="http://www.ascc.net/xml/schematron" xmlns:soap="http://schemas.xmlsoap.org/soap/envelope/" soap:dummy-for-xmlns="" xmlns:wsa="http://www.w3.org/2005/08/addressing" wsa:dummy-for-xmlns="" xmlns:wsse="http://docs.oasis-open.org/wss/2004/01/oasis-200401-wss-wssecurity-secext-1.0.xsd" wsse:dummy-for-xmlns="" version="1.0">
...
<!--SCHEMA METADATA-->
<axsl:template match="/">
<svrl:schematron-output xmlns:svrl="http://purl.oclc.org/dsdl/svrl" xmlns:schold="http://www.ascc.net/xml/schematron" xmlns:xs="http://www.w3.org/2001/XMLSchema" schemaVersion="" title="A Schematron Schema for assertion of SOAP header fields.">
<axsl:comment>
...
<svrl:ns-prefix-in-attribute-values prefix="soap" uri="http://schemas.xmlsoap.org/soap/envelope/"/>
<svrl:ns-prefix-in-attribute-values prefix="wsa" uri="http://www.w3.org/2005/08/addressing"/>
<svrl:ns-prefix-in-attribute-values prefix="wsse" uri="http://docs.oasis-open.org/wss/2004/01/oasis-200401-wss-wssecurity-secext-1.0.xsd"/>
<svrl:active-pattern>
...
<svrl:fired-rule xmlns:svrl="http://purl.oclc.org/dsdl/svrl" xmlns:schold="http://www.ascc.net/xml/schematron" xmlns:xs="http://www.w3.org/2001/XMLSchema" context="soap:Header"/>

		<!--ASSERT -->
<axsl:choose>
<axsl:when test="normalize-space(wsse:security/wsse:UsernameToken/wsse:Username) != ''"/>
<axsl:otherwise>
<svrl:failed-assert xmlns:svrl="http://purl.oclc.org/dsdl/svrl" xmlns:schold="http://www.ascc.net/xml/schematron" xmlns:xs="http://www.w3.org/2001/XMLSchema" test="normalize-space(wsse:security/wsse:UsernameToken/wsse:Username) != ''">
<axsl:attribute name="location">
<axsl:apply-templates mode="schematron-get-full-path" select="."/>
</axsl:attribute>
<svrl:text>The
				request 'soap:Header' must have a valid
				'wsse:security/wsse:UsernameToken/wsse:Username' descendant element.</svrl:text>
</svrl:failed-assert>
</axsl:otherwise>
</axsl:choose>

...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform"
	...
	<xs:annotation xmlns:xs="http://www.w3.org/2003/XMLSchema">
		<xs:appinfo xmlns:dc="http://purl.org/dc/elements/1.1/">
			<dc:creator>N.A.</dc:creator>
			<dc:date>2016-12-12</dc:date>
			<dc:title>Service003 Verification Stub</dc:title>
			<dc:subject>Provides verification services for the "Verify_Services_Interface.wsdl#Service003"
	...
	<!-- Root Template -->
	<xsl:template match="/">
		<test:Service003Response>
			<test:RequestId>
				<xsl:value-of select="test:Service003Request/test:RequestId"/>
			</test:RequestId>

...
/**
 * A custom XPathFunction to test for "lowerCamelCase" naming convention.
 * 
 * @author N.A.
 */
public class IsLowerCamelCaseFunction extends AbstractXPathFunction {

	/**
	 * A local name for the function.
	 */
	public static final String FUNCTION_LOCAL_NAME = "is-lower-camel-case";
	 ...
	 */
	private IsLowerCamelCaseFunction() {
	}
	...
	public static AbstractXPathFunction getInstance() {
		if (null == instance) {
			instance = new IsLowerCamelCaseFunction();
		}
		return instance;
	}
	...
	public Object evaluate(List arguments) throws XPathFunctionException {
		...
		// Test the string for lowerCamelCase compliance.

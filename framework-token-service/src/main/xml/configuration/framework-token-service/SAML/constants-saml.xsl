...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" exclude-result-prefixes="" version="1.0">
	<!--========================================================================
		...
		stylesheets within the DataPower STS policy flows.
	...
	<xsl:variable name="REQ_MESSAGE_SOAP_VER_VAR_NAME" select="'var://context/ESB_Services/soapVersion'"/>
	...
	<xsl:variable name="SOA_QMGR_GROUP_NAME" select="'ESB_Internal_Grp_RealTime_10M_V1'"/>
	<!--
	...
	<xsl:variable name="SOAP_11_NAMESPACE" select="'http://schemas.xmlsoap.org/soap/envelope/'"/>
	<xsl:variable name="SOAP_12_NAMESPACE" select="'http://www.w3.org/2003/05/soap-envelope'"/>
